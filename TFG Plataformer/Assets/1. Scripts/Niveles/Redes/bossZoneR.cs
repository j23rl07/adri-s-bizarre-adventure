...
public class bossZoneR : MonoBehaviour
{
    [Header("SliderHealth")]
    ...
    private void OnTriggerExit2D(Collider2D collision)
    {
        if (collision.gameObject.CompareTag("Player"))
        {
            ...
            boss.GetComponent<bossHealthR>().currentHealth = boss.GetComponent<bossHealthR>().maxHealth;
            boss.transform.position = new Vector3(205.2f, -71.5f, 0f);
            abre();
